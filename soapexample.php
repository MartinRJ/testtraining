...
define(space, " ");
define(regexp, '/<searchstring>(.*?)<\/searchstring>/s');
define(responsestart, '<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" xmlns:sam="http://www.soapui.org/sample/">
  <soap:Header/>
  <soap:Body>
    <sam:searchResponse>
        <searchresult>');
define(responseend, '</searchresult>
    </sam:searchResponse>
  </soap:Body>
</soap:Envelope>');
